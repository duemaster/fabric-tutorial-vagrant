...
docker exec cli composer transaction submit --card admin1@air-chain -d '{"$class": "org.hyperledger.composer.system.AddAsset","registryType": "Asset","registryId": "org.airline.airChain.AirlineCompany", "targetRegistry" : "resource:org.hyperledger.composer.system.AssetRegistry#org.airline.airChain.AirlineCompany", "resources": [{"$class": "org.airline.airChain.AirlineCompany","id": "Airline1","name": "Singapore Airlines", "authorisedCargoCompany": "Cargo1"}]}';

echo "Creating default Cargo Company: Cargo1"
docker exec cli composer transaction submit --card admin1@air-chain -d '{"$class": "org.hyperledger.composer.system.AddAsset","registryType": "Asset","registryId": "org.airline.airChain.CargoCompany", "targetRegistry" : "resource:org.hyperledger.composer.system.AssetRegistry#org.airline.airChain.CargoCompany", "resources": [{"$class": "org.airline.airChain.CargoCompany","id": "Cargo1","name": "Sing Air Cargo"}]}';

echo "Creating default Cargo Company: Cargo2"
docker exec cli composer transaction submit --card admin1@air-chain -d '{"$class": "org.hyperledger.composer.system.AddAsset","registryType": "Asset","registryId": "org.airline.airChain.CargoCompany", "targetRegistry" : "resource:org.hyperledger.composer.system.AssetRegistry#org.airline.airChain.CargoCompany", "resources": [{"$class": "org.airline.airChain.CargoCompany","id": "Cargo2","name": "Second Person Cargo"}]}';
